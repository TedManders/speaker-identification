########################################################
# https://github.com/TedManders/speaker-identification #
########################################################
...
class AudioUtil():
    ...
    def spectro_gram(aud, n_mels=64, n_fft=1024, hop_len=None):
        ...
        spec = torchaudio.transforms.MelSpectrogram(sr, n_fft=n_fft, hop_length=hop_len, n_mels=n_mels)(sig) # spec has shape [channel, n_mels, time]
